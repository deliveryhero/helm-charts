...
![Version: 1.3.0](https://img.shields.io/badge/Version-1.3.0-informational?style=flat-square) ![AppVersion: 2.6](https://img.shields.io/badge/AppVersion-2.6-informational?style=flat-square)
...
```console
helm install --generate-name oci://ghcr.io/deliveryhero/helm-charts/k8s-event-logger --version 1.3.0
```
