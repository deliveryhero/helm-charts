...
```console
helm install oci://ghcr.io/deliveryhero/helm-charts/prometheus-k8s-events-exporter
```

To install a specific version of this chart:

```console
helm install oci://ghcr.io/deliveryhero/helm-charts/prometheus-k8s-events-exporter --version <version>
```
