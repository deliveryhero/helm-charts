...
![Version: 0.35.0](https://img.shields.io/badge/Version-0.35.0-informational?style=flat-square) ![AppVersion: 2.32.2](https://img.shields.io/badge/AppVersion-2.32.2-informational?style=flat-square)
...
```console
helm install --generate-name oci://ghcr.io/deliveryhero/helm-charts/locust --version 0.35.0
```
