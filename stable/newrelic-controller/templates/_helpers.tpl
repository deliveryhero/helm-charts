...
*/}}
{{- define "newrelic-controller.name" -}}
...
*/}}
{{- define "newrelic-controller.fullname" -}}
...
*/}}
{{- define "newrelic-controller.chart" -}}
...
{{ default (include "newrelic-controller.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
